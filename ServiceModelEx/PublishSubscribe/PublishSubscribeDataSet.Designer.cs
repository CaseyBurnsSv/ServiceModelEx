...
SELECT Address,Operation,Contract,ID FROM PersistentSubscribers WHERE (ID = @ID)";
        ...
        private void InitConnection() 
        {
            ...
            try
            {
               this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["Service.Properties.Settings.PublishSubscribeConnectionString"].ConnectionString;
            }
            catch
            {}
